        ...
        <div class="projects">
            ...
            <div class="desc-image-parent">
                <div>
                    ...
                    <p class="desc">
                        In a team of four, we researched common mobile problems faced such as the 'fat finger problem',
                        limited space and lack of hover states. A UI/UX style-guide for mobile visualizations was designed,
                        incorporating solutions such as 
                        <ul>
                            <li>using large interactable areas and staggered handles to combat fat finger problems</li>
                            <li>using tabs instead of menu buttons and using portrait mode to use space efficiently</li>
                            <li>designing to avoid interference with screen-edge gestures</li>
                        </ul> 
                        We <a class="link-in-text" title="Download the app - https://moin.vrsys.org/MoInVisApp.apk" href="https://moin.vrsys.org/MoInVisApp.apk" target="_blank">
                        <i>built an app</i></a> that visualized the amounts of different kinds of waste generated by European countries, 
                        using a parallel coordinates visualization. 
                        <a class="link-in-text" title="https://moin.vrsys.org/" href="https://moin.vrsys.org/" target="_blank">
                            <i>Check it out with a mobile browser here!</i>
                        </a>
                    </p>
                </div>     
                <ImageModaller class="landscape-image-parent" image-src="./images/MoInViz-Waste-Paracoords.png" v-slot="{ onClick }"
                caption="Visualizing waste generation with Parallel Coordinates on mobile devices" >
                    <div style="text-align: center">
                        <img class="landscape-images"
                            src="./images/MoInViz-Waste-Paracoords.png"  
                            v-on:click="onClick"/>
                    </div>
                </ImageModaller>
            </div> 
            ...
            <div class="desc-image-parent">
                <ImageModaller class="landscape-image-parent" image-src="./images/F1Viz.png" v-slot="{ onClick }"
                ...
                <div>        
                    <p class="desc">
                        In a team of two, I created an <a class="link-in-text" title="./F1DataVis/index.html" href="./F1DataVis/index.html" target="_blank"><i>interactive parallel coordinates visualization</i></a> 
                        visualizing more than 20 years of Formula1 data. From 1996 to 2017, the journeys of Formula1 teams in each season, and the stories of F1 drivers in each grand prix was visualised.
                    </p>
                </div>     
            </div>
            <div class="desc-image-parent">
                ...
                <ImageModaller class="landscape-image-parent" image-src="./images/ModernTech-Spirituality-Poster.png" v-slot="{ onClick }"
